	...
	<div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
		<div class="panel panel-default">
			<div class="panel-body">
				 <form accept-charset="UTF-8" role="form" method="post" enctype="multipart/form-data" action="{{ route('admin.job_records.store') }}">
					<div class="form-group {{ ($errors->has('task'))  ? 'has-error' : '' }}">
                        <label>Zadatak</label>
						<input name="task" type="text" class="form-control" value="{{ old('task') }}" required >
					...
					<div class="form-group {{ ($errors->has('time')) ? 'has-error' : '' }}">
						<label>Vrijeme:</label>
						<input name="time" type="time" class="form-control" value ="00:00">
					...
					<div class="form-group {{ ($errors->has('odjel')) ? 'has-error' : '' }}">
						<label>Odjel:</label>
						<input name="odjel" type="text" class="form-control" >
