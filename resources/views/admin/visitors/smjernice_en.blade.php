...
<form accept-charset="UTF-8" role="form" class="visitor_form" method="post" action="{{ route('admin.visitors.store') }}">
    ...
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_forbidden.jpg') }}" />	access to places and entrance to the space to which the visitor is not intended is prohibited</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_stop.jpg') }}" /> it is forbidden to stay in the vicinity of equipment and machines in operation, without supervision</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_smoke.jpg') }}" />	smoking is prohibited on company premises</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_food.jpg') }}" /> it is forbidden to intake and consume food and beverages</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_photo.jpg') }}" /> it is forbidden to take photographs and recordings without the express, written consent of an authorized person</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_escort.jpg') }}" /> visitors are required to be accompanied by the host and follow his instructions</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_glove.jpg') }}" /> if required, wear appropriate protective equipment provided by the host</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_garbage.jpg') }}" /> dispose of waste only in containers provided for this purpose, paying attention to the separation of waste by type, if possible</p>
    ...
    <div class="alert_box video">
        <span class="alert_icons">
            <img class="icon_alert" src="{{ asset('img/icons/icon_video.jpg') }}" /> 
    ...
    <div class="alert_box">
        <span class="alert_icons">
            <img class="icon_alert" src="{{ asset('img/icons/icon_out.jpg') }}" /> 
            <img class="icon_alert" src="{{ asset('img/icons/icon_right.jpg') }}" /> 
            <img class="icon_alert" src="{{ asset('img/icons/icon_left.jpg') }}" /> 
        </span>
    ...
    <a href="{{ asset('img/en/Plan_evakuacije_pr.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_pr.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/en/Plan_evakuacije_1.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_1.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/en/Plan_evakuacije_2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_2.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/en/Plan_evakuacije_h.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_h.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/en/Plan_evakuacije_h_prolaz.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_h_prolaz.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/en/Plan_evakuacije_h2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/en/Plan_evakuacije_h2.png') }}" style="max-width:100%" />
    </a>
...
{{-- 
Alle Bestimmungen des Arbeitsschutzgesetzes und der Allgemeinen Vorschriften für arbeiten in sicherer Umgebung
Warnschilder, Warnungen und Gefahren beachten
Befolgen Sie alle Anweisungen des Gastgebers
Entsorgen Sie die Abfälle ausschließlich in den dafür vorgesehenen Behältern und achten Sie nach Möglichkeit auf die sortenreine Trennung der Abfälle.
Es ist untersagt:
Zugang zu Orten, an denen kein Besuch geplant ist
Unbeaufsichtigt in Arbeitszonen mit maschinen unterwegs zu sein
Rauchen auf dem Firmengelände, Betreten und Konsumieren von Alkohol und anderen Rauschmitteln --}}