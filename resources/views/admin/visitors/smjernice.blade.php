...
<form accept-charset="UTF-8" role="form" class="visitor_form" method="post" action="{{ route('admin.visitors.store') }}">
    ...
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_forbidden.jpg') }}" /> zabranjen je pristup mjestima i ulaz u prostorije na kojima posjet nije predviđen </p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_stop.jpg') }}" /> zabranjeno je zadržavanje u blizini opreme i strojeva u radu, bez nadzora</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_smoke.jpg') }}" /> zabranjeno je pušenje u prostorijama tvrtke</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_food.jpg') }}" /> zabranjeno unošenje i konzumiranje hrane i pića</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_photo.jpg') }}" /> zabranjeno fotografiranje i snimanje bez izričitog, pismenog odobrenja ovlaštene osobe</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_escort.jpg') }}" /> posjetitelji su obvezni biti uvijek u pratnji domaćina i slijediti njegove upute</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_glove.jpg') }}" /> ukoliko je obvezno, nositi odgovarajuću zaštitnu opremu koju osigurava domaćin</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_garbage.jpg') }}" /> otpad odložiti isključivo u za to predviđene posude obraćajući pažnju na odvajanje otpada po vrstama, ukoliko je to omogućeno</p>
    ...
    <a href="{{ asset('img/hr/Plan_evakuacije_pr.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_pr.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/hr/Plan_evakuacije_1.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_1.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/hr/Plan_evakuacije_2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_2.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/hr/Plan_evakuacije_h.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_h.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/hr/Plan_evakuacije_h_prolaz.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_h_prolaz.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/hr/Plan_evakuacije_h2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/hr/Plan_evakuacije_h2.png') }}" style="max-width:100%" />
    </a>
    <div class="form-group smjernice">
        <div class="{{ ($errors->has('accept')) ? 'has-error' : '' }} ">
            <label>
                <input name="accept" type="checkbox" value="1" {{ old('accept') == 'checked' ? 'checked' : ''}}  > <b>Potvrđujem da sam pročitao/la, da razumijem i prihvaćam upute za sigurnost posjetitelja!</b>
            </label>
