...
<form accept-charset="UTF-8" role="form" class="visitor_form" method="post" action="{{ route('admin.visitors.store') }}">
    ...
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_forbidden.jpg') }}" /> Der Zugang zu Orten und Räumen, in denen kein Besuch geplant ist, ist verboten</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_stop.jpg') }}" /> Es ist verboten, sich ohne Aufsicht in der Nähe von Geräten und Maschinen aufzuhalten, die in Betrieb sind</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_smoke.jpg') }}" /> Das Rauchen auf dem Firmengelände ist verboten</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_food.jpg') }}" /> Es ist verboten, Essen und Trinken mitzubringen und zu konsumieren</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_photo.jpg') }}" /> Es ist verboten, Fotos und Aufzeichnungen ohne die ausdrückliche schriftliche Genehmigung einer autorisierten Person aufzunehmen</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_escort.jpg') }}" /> Besucher müssen immer vom Gastgeber begleitet werden und seine Anweisungen befolgen</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_glove.jpg') }}" /> Falls benötig,tragen Sie eine vom Gastgeber bereitgestellte Schutzausrüstung</p>
    <p><img class="icon_alert" src="{{ asset('img/icons/icon_garbage.jpg') }}" /> Entsorgen Sie Abfälle nur in dafür vorgesehenen Behälter, wobei Sie nach Möglichkeit auf die Trennung der Abfälle achten.</p>
    ...
    <a href="{{ asset('img/de/Plan_evakuacije_pr.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_pr.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/de/Plan_evakuacije_1.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_1.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/de/Plan_evakuacije_2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_2.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/de/Plan_evakuacije_h.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_h.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/de/Plan_evakuacije_h_prolaz.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_h_prolaz.png') }}" style="max-width:100%" />
    </a>
    <a href="{{ asset('img/de/Plan_evakuacije_h2.png') }}" class="evacuation_plan">
        <img src="{{ asset('img/de/Plan_evakuacije_h2.png') }}" style="max-width:100%" />
    </a>
