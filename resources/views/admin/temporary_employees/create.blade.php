...
<div class="page-header">
  <h2>Prijava privremenog radnika</h2>
</div> 
<div class="">
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-default">
			<div class="panel-body">
				 <form accept-charset="UTF-8" role="form" method="post" action="{{ route('admin.temporary_employees.store') }}">
					...
					<div class="form-group">
						...
						<input name="datum_prijave" class="date form-control" type="date" value ="{{ Carbon\Carbon::now()->format('Y-m-d') }}" required>
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="napomena" maxlength="255"></textarea>
					</div>
					<div class="form-group">
						<input type="checkbox" name="odjava" value="1" id="odjava" > <label for="odjava">Djelatnik je odjavljen</label>
					</div>				
					{{ csrf_field() }}
