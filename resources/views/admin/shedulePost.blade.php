        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <fieldset>
					...
					<input type="text" name="content" value="Ja, {{ $user->first_name . ' ' .  $user->last_name}}, nisam raspoređen za dan" class="form-control" readonly />
					<input name="user_id" type="hidden" value="{{ $user->id }}" />
					<div class="form-group">
						<input name="datum" type="date" class="datum form-control" />
					</div>
					<input name="content2" type="text" value="Molim da mi se dodijeli projekt u trajanju od" class="form-control"  />
					<div class="form-group">
